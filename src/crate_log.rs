...
macro_rules! log {
    (target: $target:expr, $lvl:expr, $($arg:tt)+) => ({
        static _LOC: $crate::my_strategy::log::LogLocation = $crate::my_strategy::log::LogLocation {
            __line: line!(),
            __file: file!(),
            __module_path: module_path!(),
        };
        let lvl = $lvl;
        if lvl <= $crate::my_strategy::log::__static_max_level() && lvl <= $crate::my_strategy::log::max_log_level() {
            $crate::my_strategy::log::__log(lvl, $target, &_LOC, format_args!($($arg)+))
        }
    });
...
macro_rules! error {
    (target: $target:expr, $($arg:tt)*) => (
        log!(target: $target, $crate::my_strategy::log::LogLevel::Error, $($arg)*);
    );
    ($($arg:tt)*) => (
        log!($crate::my_strategy::log::LogLevel::Error, $($arg)*);
    )
}
...
macro_rules! warn {
    (target: $target:expr, $($arg:tt)*) => (
        log!(target: $target, $crate::my_strategy::log::LogLevel::Warn, $($arg)*);
    );
    ($($arg:tt)*) => (
        log!($crate::my_strategy::log::LogLevel::Warn, $($arg)*);
    )
}
...
macro_rules! info {
    (target: $target:expr, $($arg:tt)*) => (
        log!(target: $target, $crate::my_strategy::log::LogLevel::Info, $($arg)*);
    );
    ($($arg:tt)*) => (
        log!($crate::my_strategy::log::LogLevel::Info, $($arg)*);
    )
}
...
macro_rules! debug {
    (target: $target:expr, $($arg:tt)*) => (
        log!(target: $target, $crate::my_strategy::log::LogLevel::Debug, $($arg)*);
    );
    ($($arg:tt)*) => (
        log!($crate::my_strategy::log::LogLevel::Debug, $($arg)*);
    )
}
...
macro_rules! trace {
    (target: $target:expr, $($arg:tt)*) => (
        log!(target: $target, $crate::my_strategy::log::LogLevel::Trace, $($arg)*);
    );
    ($($arg:tt)*) => (
        log!($crate::my_strategy::log::LogLevel::Trace, $($arg)*);
    )
}
...
macro_rules! log_enabled {
    (target: $target:expr, $lvl:expr) => ({
        let lvl = $lvl;
        lvl <= $crate::my_strategy::log::__static_max_level() && lvl <= $crate::my_strategy::log::max_log_level() &&
            $crate::my_strategy::log::__enabled(lvl, $target)
    });
